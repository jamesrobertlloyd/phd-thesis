...
We also build up some notation for a particular exchangeable database $(X^{r_j})_{j=1}^R$\fTBD{Any way to make this notation easier?}.
...
\fTBD{Sort out the usage of $k$ and $i$ and upper lower case}
