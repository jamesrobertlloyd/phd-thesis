...
\begin{proof}
  For each $i$ and conditioned on $U_i$, ${X}_{ij} \independent {X}_{ij'} \, \forall \, j \neq j'$.
...
\begin{thm}[almost sure functional representation for exchangeable databases]
  ...
  A database $(X^{r_j})_{j=1}^R$ is exchangeable iff there exist measurable functions $f^j : [0,1]^{2^{d_j}} \to S_j$ and $U$-array $\xi$ such that
  \begin{equation}
