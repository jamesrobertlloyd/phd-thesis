...
In the case of graphs, the only assumptions are (i) and (ii) \citep[e.g.][]{Diaconis2007-mi}.
...
\begin{figure}[ht]
  ...
  \caption[Unsorted and sorted protein interactome and visualisation of model fit.]{Protein interactome data. 
    ...
    \emph{Right:} Maximum a posteriori estimate of the function $\AHfunction$, corresponding to the function in figure~\ref{fig:W:graph} (middle).
  }
