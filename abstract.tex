...
A simpler data structure to specify probability distributions for is that of functions; many probability distributions for functions have been used for centuries.
