...
\end{tabularx}
\caption[Samples of Gaussian processes with differnet kernels.]{
...
\end{tabularx}
\caption[Samples of Gaussian processes with compositionally constructed kernels.]{Examples of structures expressible by
  composite kernels.  
