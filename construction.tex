...
\citet{Diosan2007-un, Bing2010-of} and \citet{kronberger2013evolution} learn composite kernels for support vector machines, relevance vector machines and Gaussian processes, using genetic search algorithms.
...
In contrast, our work learns a parametric form for the covariance, allowing it to model functions without a simple parametric form.
