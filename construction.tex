...
For example, in data with periodic structure, integer multiples of the true period (\ie subharmonics) are often local optima. 
...
\footnotetext{Admittedly this was intended as reference material}
