...
This version of the periodic kernel is now implemented in the GPML toolbox \fTBD{cite} and is available at \url{gaussianprocess.org/gpml/code/matlab/cov/covPeriodicNoDC.m}
...
We use this as a base kernel and replace the model likelihood with a Dirac delta function.
