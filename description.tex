...
An even more extreme pathological behaviour can be seen in figure~\ref{fig:description:rq_per}\fTBD{Find / make me} where a kernel of the form $\kRQ \kerntimes \kPer$ has explained a data set which \procedurename{} has more naturally described as a sum of a periodic component and uncorrelated noise.
