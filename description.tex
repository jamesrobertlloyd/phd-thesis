...
We construct changepoints by assuming that the function we are attempting to model transitions between two different different functions with the transition controlled by a sigmoidal function $\sigma$:
\[
...
Since we have an updated set of base kernels and operators we review the base kernels and search operators.
...
An example of a full automatically-generated report is provided in appendix \TBD{add and make reference}.
...
\TBD{Update me. Frequentist auto-stat work. Look for other people citing our work.}
